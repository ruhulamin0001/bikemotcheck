...
function homePage(prefill){
  ...
  '<section class="card glass">',
  '<div class="vhead"><div>',
  '<h2 style="margin:0 0 6px">Need the full history? Finance, write-off and stolen checks</h2>',
  '<p class="meta" style="margin:0">The MOT record above is free, forever. Outstanding finance, insurance write-offs and police stolen markers live in licensed databases &mdash; our full report covers them at <strong>launch pricing: &pound;3.99</strong> <s>&pound;9.99</s> until 31 December 2026.</p>',
  '</div><div>',
  '<a class="btn" style="text-decoration:none;display:inline-block;padding:14px 22px" href="/history-check">See the full report &mdash; &pound;3.99</a>',
  '</div></div>',
  '</section>',
  '<section>',
