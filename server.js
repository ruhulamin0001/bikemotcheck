...
const MOT_FAQ = [
  { q:'Is it really free?', a:'Yes. No sign up, no payment, no limit for normal use. The DVSA data is free to read; we pay for the server.' },
  { q:'Does it cover Northern Ireland?', a:'No. DVSA holds records for England, Scotland and Wales. Northern Ireland MOTs are run by the DVA.' },
  { q:'Do you store the registrations I look up?', a:'No. Nothing is written to a database. Your recent searches stay in your own browser, and Clear removes them.' }
];
const ULEZ_FAQ = [
...
function head(title, desc, canon, faqList){
  ...
  '<nav class="nav"><a href="/ulez">ULEZ</a><a href="/guides">Guides</a><a href="/compare">Compare</a><a href="/reminders">Reminders</a><a href="/history-check">Full check</a></nav>',
  '</div></header>'
  ].join('');
}
...
function homePage(prefill){
  /* The page is one job: type a registration, get the record. Everything that is not that
     was pushed below the fold or off the page entirely. The long explanations now live in
     the guides, where somebody searching for them will actually land. */
  return [
  ...
  '<p class="sub">Every test, mileage reading and advisory since 2005. Cars, vans, motorcycles and lorries.</p>',
  searchBlock(prefill),
  '<div class="trust"><span>Official DVSA data</span><span>No sign up</span><span>Free</span></div>',
  '</section>',
  '<div id="out"></div>',
  '<section class="card glass">',
  '<h2 style="margin:0 0 6px;font-size:19px">Finance, write-off and stolen checks</h2>',
  '<p class="meta" style="margin:0 0 12px">The MOT record is free forever. Finance, write-offs and theft markers sit in licensed databases. Our full report covers them at <strong>&pound;3.99</strong> launch pricing.</p>',
  '<a class="btn" style="text-decoration:none;display:inline-block" href="/history-check">See the full report &mdash; &pound;3.99</a>',
  '</section>',
  '<section>',
  '<h2>What to look for</h2>',
  '<ul>',
  '<li><strong>Mileage that goes backwards.</strong> Every test records the odometer. A drop is the one thing you can prove, and we flag it automatically.</li>',
  '<li><strong>The same advisory year after year.</strong> One advisory is nothing. The same one four years running is a fault nobody has fixed.</li>',
  '<li><strong>What it cannot tell you.</strong> Nothing about the clutch, gearbox or engine internals, and nothing about finance. A car can pass on the morning its head gasket goes.</li>',
  '</ul>',
  '<p class="meta"><a href="/guides/spot-a-clocked-car-uk">How to spot a clocked car</a> &middot; <a href="/guides/what-fails-an-mot-uk">What actually fails an MOT</a> &middot; <a href="/guides">All guides</a></p>',
  '</section>',
  '<section>',
  '<h2>Frequently asked</h2>',
  '<h3>Is it really free?</h3>',
  '<p>Yes. No sign up, no payment, no limit for normal use. The DVSA data is free to read; we pay for the server.</p>',
  '<h3>Does it cover Northern Ireland?</h3>',
  '<p>No. DVSA holds records for England, Scotland and Wales. Northern Ireland MOTs are run by the DVA.</p>',
  '<h3>Do you store the registrations I look up?</h3>',
  '<p>No. Nothing is written to a database. Your recent searches stay in your own browser, and Clear removes them.</p>',
  '</section>',
  '</main>',
  footer(),
  '<script src="/app.js" defer></' + 'script>'
...
function historyCheckPage(){
  var faq = [
    ...
    { q:'How much will it cost?',
      a:'£3.99 for a single report at launch pricing, locked until 31 December 2026, and £11.99 for a three-report pack. The standard prices of £9.99 and £24.99 apply from 1 January 2027. The market leader charges around £20 for the same underlying data.' },
  ...
  head('Full Vehicle History Check: Finance, Write-Off, Stolen',
       'What a full vehicle history check adds to the free MOT report: finance, write-off, stolen marker, keeper count and valuation. Launch price £3.99 until 31 Dec 2026.',
  ...
  '</tbody></table>',
  '<h2>Launch pricing, locked until 31 December 2026</h2>',
  '<p>The data behind these reports comes from the same licensed sources every provider uses; the market leader charges around &pound;20. From <strong>1 January 2027</strong> the standard prices apply. Until then, launch pricing:</p>',
  '<div class="stats">',
  '<div class="stat" style="text-align:center;padding:22px 16px">',
  '<div class="k">Single report</div>',
  '<div class="v ok" style="font-size:34px">&pound;3.99</div>',
  '<div class="n"><s>&pound;9.99</s> standard price from 1 Jan 2027</div>',
  '<div class="n">One registration, full report</div>',
  '</div>',
  '<div class="stat" style="text-align:center;padding:22px 16px">',
  '<div class="k">Three-report pack</div>',
  '<div class="v ok" style="font-size:34px">&pound;11.99</div>',
  '<div class="n"><s>&pound;24.99</s> standard price from 1 Jan 2027</div>',
